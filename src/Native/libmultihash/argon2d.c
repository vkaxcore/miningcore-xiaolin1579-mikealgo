...
void argon2d_crds_call(const char* input, char* output)
{
...
void argon2d_dyn_call(const char* input, char* output)
{
    argon2_context context;
    context.out = (uint8_t *)output;
    context.outlen = (uint32_t)OUTPUT_BYTES;
...
void argon2d16000_call(const char* input, char* output)
{
    argon2_context context;
    context.out = (uint8_t *)output;
    context.outlen = (uint32_t)OUTPUT_BYTES;
